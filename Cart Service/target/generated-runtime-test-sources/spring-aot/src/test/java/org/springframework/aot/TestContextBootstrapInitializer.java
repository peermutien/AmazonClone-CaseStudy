...
public class TestContextBootstrapInitializer {
  public static Map<String, Supplier<SmartContextLoader>> getContextLoaders() {
    ...
    entries.put("com.capg.CartServiceApplicationTests", () -> new AotSpringBootConfigContextLoader(CartServiceApplicationTestsContextInitializer.class, WebApplicationType.SERVLET, SpringBootTest.WebEnvironment.MOCK));
    return entries;
  }
  ...
  public static Map<String, Class<? extends ApplicationContextInitializer<?>>> getContextInitializers(
    ...
    entries.put("com.capg.CartServiceApplicationTests", CartServiceApplicationTestsContextInitializer.class);
    return entries;
  }
}
