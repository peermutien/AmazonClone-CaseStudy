...
public abstract class StaticSpringFactories {
  ...
  static {
    ...
    factories.add(org.springframework.data.web.config.SpringDataJacksonModules.class, () -> new org.springframework.data.mongodb.config.GeoJsonConfiguration());
    ...
    factories.add(org.springframework.cloud.bootstrap.BootstrapConfiguration.class, () -> new org.springframework.cloud.bootstrap.config.PropertySourceBootstrapConfiguration());
    factories.add(org.springframework.cloud.bootstrap.BootstrapConfiguration.class, () -> new org.springframework.cloud.bootstrap.encrypt.EncryptionBootstrapConfiguration());
    factories.add(org.springframework.cloud.bootstrap.BootstrapConfiguration.class, () -> new org.springframework.cloud.autoconfigure.ConfigurationPropertiesRebinderAutoConfiguration());
    factories.add(org.springframework.cloud.bootstrap.BootstrapConfiguration.class, () -> new org.springframework.boot.autoconfigure.context.PropertyPlaceholderAutoConfiguration());
    ...
    factories.add(org.springframework.boot.diagnostics.FailureAnalyzer.class, () -> new org.springframework.cloud.configuration.CompatibilityNotMetFailureAnalyzer());
    ...
    names.add(RepositoryFactorySupport.class, "org.springframework.data.mongodb.repository.support.MongoRepositoryFactory");
    ...
    factories.add(org.springframework.boot.env.EnvironmentPostProcessor.class, () -> new org.springframework.cloud.bootstrap.encrypt.DecryptEnvironmentPostProcessor());
    factories.add(org.springframework.boot.env.EnvironmentPostProcessor.class, () -> new org.springframework.cloud.util.random.CachedRandomPropertySourceEnvironmentPostProcessor());
    factories.add(org.springframework.boot.env.EnvironmentPostProcessor.class, () -> new org.springframework.cloud.client.HostInfoEnvironmentPostProcessor());
    ...
    factories.add(org.springframework.boot.BootstrapRegistryInitializer.class, () -> new org.springframework.cloud.bootstrap.RefreshBootstrapRegistryInitializer());
    factories.add(org.springframework.boot.BootstrapRegistryInitializer.class, () -> new org.springframework.cloud.bootstrap.TextEncryptorConfigBootstrapper());
    ...
    factories.add(org.springframework.context.ApplicationListener.class, () -> new org.springframework.cloud.bootstrap.BootstrapApplicationListener());
    factories.add(org.springframework.context.ApplicationListener.class, () -> new org.springframework.cloud.bootstrap.LoggingSystemShutdownListener());
    factories.add(org.springframework.context.ApplicationListener.class, () -> new org.springframework.cloud.context.restart.RestartListener());
  }
}
